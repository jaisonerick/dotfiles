...
vim.keymap.set('v', '<leader>jq', "<cmd>'<,'>! jq -M<cr><Esc>", { silent = true, desc = 'Format selected JSON' })
vim.keymap.set('n', '<leader>jq', "<cmd>%!jq .<cr>", { silent = true, desc = 'Format JSON current buffer' })
